...
class TuyaUserModule(reactContext: ReactApplicationContext?) : ReactContextBaseJavaModule(reactContext!!) {
    ...
    private fun getLoginCallback(promise: Promise): ILoginCallback? {
        return object : ILoginCallback {
    ...
    private fun getRegisterCallback(promise: Promise): IRegisterCallback? {
    ...
    private fun getResetPasswdCallback(promise: Promise): IResetPasswordCallback? {
    ...
    private fun getValidateCodeCallback(promise: Promise): IValidateCallback {
    ...
    private fun getIBooleanCallback(promise: Promise): IBooleanCallback? {
