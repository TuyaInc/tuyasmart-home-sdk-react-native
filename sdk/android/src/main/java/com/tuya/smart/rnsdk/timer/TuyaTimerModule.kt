...
class TuyaTimerModule(reactContext: ReactApplicationContext?) : ReactContextBaseJavaModule(reactContext!!) {
    ...
    private fun getIGetAllTimerWithDevIdCallback(promise: Promise): IGetAllTimerWithDevIdCallback {
    ...
    private fun getIGetTimerWithTaskCallback(promise: Promise): IGetTimerWithTaskCallback {
