...
class TuyaFeedBackModule(reactContext: ReactApplicationContext?) : ReactContextBaseJavaModule(reactContext!!) {
    ...
    fun getFeedbackList(promise: Promise) {
        TuyaHomeSdk.getTuyaFeekback().feedbackManager.getFeedbackList(object : ITuyaDataCallback<List<FeedbackBean>> {
    ...
    fun getFeedbackType(promise: Promise) {
        TuyaHomeSdk.getTuyaFeekback().feedbackManager.getFeedbackType(object : ITuyaDataCallback<List<FeedbackTypeRespBean>> {
    ...
    fun addFeedback(params: ReadableMap, promise: Promise) {
        if (ReactParamsCheck.checkParams(arrayOf(Constant.MESEAGE, Constant.CONTACT, Constant.HDID, Constant.HDTYPE), params)) {
            TuyaHomeSdk.getTuyaFeekback().feedbackManager.addFeedback(params.getString(Constant.MESEAGE), params.getString(Constant.CONTACT),
